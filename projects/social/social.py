...
class SocialGraph:
    ...
    def populate_graph(self, num_users, avg_friendships):
        ...
        # * Hint 1: To create N random friendships, you could create a list with all possible friendship combinations, shuffle the list, then grab the first N elements from the list. 

...
1. To create 100 users with an average of 10 friends each, how many times would you need to call `add_friendship()`? Why?   at most 50, because you only need 1 established connection as friendship is bi-directional.
